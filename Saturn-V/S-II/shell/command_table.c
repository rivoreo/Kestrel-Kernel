...
#define DECLARE_COMMAND(N,U) extern int N##_command(int, char **); static command_t c_##N = { #N, N##_command, U };
...
DECLARE_COMMAND(graphics, "graphics on|off");
...
DECLARE_COMMAND(threadtest, "threadtest");
DECLARE_COMMAND(uptime, "uptime");
